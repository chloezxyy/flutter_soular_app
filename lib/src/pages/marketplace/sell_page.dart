          ...
          child: Stack(
            ...
            children: <Widget>[
              Positioned(
                  top: 10,
                  right: -120,
                  child: _circularContainer(300, Colors.yellow[500])),
              Positioned(
                  top: -60,
                  left: -65,
                  child: _circularContainer(width * .5, Colors.yellow[500])),
              Positioned(
                  top: -230,
                  right: -30,
    ...
    return Container(
      ...
      child: Column(children: <Widget>[
        Padding(
          ...
          child: Text("Enter amount to sell", style: TextStyle(fontSize: 19)),
        ),
        TextField(
